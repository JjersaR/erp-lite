...
import com.jersa.customer.ICustomerProviderService;
...
@Slf4j
@Service
public class JsonPlaceholderCustomerProviderAdapter implements ICustomerProviderService {

    private final RestClient jsonClient;
    private final ICustomerInfoMapper mapper;
    private final String endpoint;

    public JsonPlaceholderCustomerProviderAdapter(@Qualifier("jsonplaceholder") RestClient restClient, ICustomerInfoMapper mapper, RJsonplaceholderProperties props) {
